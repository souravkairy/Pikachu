                                        ...
                                        <div class="card-info">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <h2 class="num-text text-white mb-5 font-w600">
                                                    ${{ $totalIncome = $user_data->traiding_bonous + $ref_commission  ?? null }}
                                                </h2>
                                            </div>
                                            {{-- <div class="d-flex">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="modal fade" id="basicModal">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">@if ($user_data->wallet_address)
                                                                    {{ $user_data->wallet_address }}
                                                                @else
                                                                 <p>Please set your wallet Address From Withdraw Section</p>
                                                                @endif
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-4">
                                                        ...
                                                        @empty
                                                        <li>
                                                            <h6 class="text-black">no active packages</h6>
                                                        </li>
                                                        @endforelse
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-lg">
                                                        ...
                                                        <input type="hidden"
                                                            ...
                                                            name="wallet_address">
                                                        <input type="hidden" value="{!! $item->customer_id ?? null !!}"
                                                            name="customer_id">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody>
                                        @php
                                            $ff = ($totalIncome * 100) / $activePackages->sum('traiding_limit');
                                            // $ff = ($totalIncome * 100) / 100;
                                        ...
                                        @endphp
                                            <tr>
                                                {{-- <td></td> --}}
                                                <td>
                                                    <h3 class="float-left">{{ $totalIncome }}$</h3>
                                                        <h3 class="float-right">{{$activePackages->sum('traiding_limit') }}$</h3>
                                                        <div class="progress mb-2">
                                                            <div class="progress-bar progress-animated bg-warning"
                                                                style="{{ $dd }}"></div>
                                                        </div>
                                                        <br>
                                                        <small>{{ session::get('t_percentage') }}% Will be added in your
                                                            account as traiding bonous</small>
                                                </td>
                                                {{-- <td></td> --}}
                                            </tr>
                                            {{-- @forelse ($activePackages as $item)
                                                @php
                                                    $ff = ($item->traiding_balance * 100) / $item->traiding_limit;
                                                    $dd = "width : $ff%";
                                                @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="float-left">{{ $item->traiding_balance }}$</h3>
                                ...
                                <div class="card">
                                    <div class="card-header pb-2 d-block d-sm-flex flex-wrap border-0">
                                        <div class="mb-3">
                                            ...
                                            <p class="mb-0 fs-13">List of your withdraw status</p>
                                        </div>
                                                        ...
                                                        @forelse ($withdraw_status_list as $item)
                                                            @if ($item->status == 'pending')
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span
                                                                            class="font-w600 text-black">{{ $item->withdraw_amount }}$</span>
                                                                    </td>
                                                                    <td>
                                                                        <span
                                    ...
                                    <div class="card-footer border-0 p-0 caret">
                                        <a href="{{ url('user-work-station') }}" class="btn-link mt-1"><i
