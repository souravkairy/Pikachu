					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header border-0 pb-0">
								...
								<img src="{{asset('BackEnd/assets/images/svg/dollar-symbol.svg')}}" alt="">
							</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="owl-bank-wallet owl-carousel owl-loaded owl-drag mb-4">
									<div class="items">
										<img class="mw-100" src="{{asset('BackEnd/assets/images/card/card1.jpg')}}" alt="">
									</div>
									<div class="items">
										<img  class="mw-100" src="{{asset('BackEnd/assets/images/card/card2.jpg')}}" alt="">
									</div>
									<div class="items">
										<img  class="mw-100" src="{{asset('BackEnd/assets/images/card/card3.jpg')}}" alt="">
									</div>
								</div>
					...
					<div class="col-xl-6 col-xxl-8 col-lg-8">
						<div class="card">
							<div class="card-header d-block d-sm-flex border-0">
								<div>
									<h4 class="fs-20 text-black">Best Earners</h4>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-sm-6">
						<div class="card">
							<div class="card-header border-0">
								<h4 class="mb-0 text-black fs-20">Today's Investment</h4>
							</div>
							<div class="card-body p-0">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="testimonial-one owl-right-nav owl-carousel owl-loaded owl-drag">
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/10.jpg')}}" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/11.jpg')}}" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/12.jpg')}}" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/13.jpg')}}" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/14.jpg')}}" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{asset('BackEnd/assets/images/profile/15.jpg')}}" alt="">
