...
<head>
    ...
    <title>PIKAFUTURE Admin Dashboard </title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{url('/admin/home')}}" class="brand-logo">
                ...
                <h2 class="brand-title">PIKAFUTURE</h2>
            </a>
		...
		<div class="chatbox">
			...
			<div class="custom-tab-1">
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#chat">Contact Messages</a>
					</li>
				</ul>
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						<div class="card mb-sm-3 mb-md-0 note_card">
							<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body2">
								<ul class="contacts">
                                    {{-- @forelse ($contactMessage as $item)
                                    <li class="active">
                                    ...
                                    @empty
                                        <h6 class="text-center p-2">No Message </h6>
                                    @endforelse --}}
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right main-notification">
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon mr-2" href="{{url('/')}}" >
                                    <img width="24" height="24" src="{{asset('BackEnd/assets/icons/flaticon/home.svg')}}" alt="">
                               </a>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="javascript:void(0)">
									...
									{{-- <span class="badge light text-white bg-primary rounded-circle">{{$contactMessage->count()}}</span> --}}
                                </a>
							</li>
							{{-- <li class="nav-item dropdown notification_dropdown">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{asset('BackEnd/assets/images/profile/user.svg')}}" width="20" alt=""/>
